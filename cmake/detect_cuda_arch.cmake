...
#
# Compiles and runs a tiny CUDA program to detect the current GPU's compute
# capability (major.minor, e.g. "89" for RTX 4090). Sets <output_var> on
# success; leaves it unchanged on failure.
#
...
int main() {
  ...
  if(_run_ret EQUAL 0 AND _arch)
    ...
    if(_arch MATCHES "^[89][0-9]$|^[5-9][0-9]$")
      ...
      message(
        STATUS "Invalid CUDA architecture output '${_arch}', using default")
    endif()
  endif()
endfunction()
