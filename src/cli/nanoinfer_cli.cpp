/**
 * NanoInfer CLI - Command-line inference tool
 *
 ...
 *
 * Usage:
 *   nanoinfer-cli -m model.gguf                    # Interactive chat
 *   nanoinfer-cli -m model.gguf -p "Hello"         # Text completion
 *   nanoinfer-cli -m model.gguf --mmproj mm.gguf   # Multimodal
 *   nanoinfer-cli -m model.gguf --info             # Model info
 */
