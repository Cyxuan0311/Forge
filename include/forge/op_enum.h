...
inline std::string op_type_name(OpType op) {
    switch (op) {
        ...
        case OpType::MUL_MAT: return "mul_mat";
        case OpType::MUL_MAT_TRANSB: return "mul_mat_transB";
        case OpType::MUL_MAT_ID: return "mul_mat_id";
        case OpType::OUT_PROD: return "out_prod";
        case OpType::SOFT_MAX: return "soft_max";
        case OpType::SOFT_MAX_MASKED: return "soft_max_masked";
        case OpType::FLASH_ATTN_EXT: return "flash_attn_ext";
        case OpType::FLASH_ATTN_GQA: return "flash_attn_gqa";
        ...
        case OpType::CPY_K: return "cpy_k";
        case OpType::CPY_V: return "cpy_v";
        case OpType::GET_K: return "get_k";
        case OpType::GET_V: return "get_v";
        case OpType::CUSTOM: return "custom";
        case OpType::COUNT: return "count";
    }
    return "unknown";
}
