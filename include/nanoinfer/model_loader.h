...
#define NANOINFER_REGISTER_LOADER_IMPL2(line, name, creator) \
    static ::nanoinfer::LoaderAutoRegister _loader_reg_##line(name, creator)

#define NANOINFER_REGISTER_LOADER_IMPL(line, name, creator) \
    NANOINFER_REGISTER_LOADER_IMPL2(line, name, creator)

#define NANOINFER_REGISTER_LOADER(name, creator) \
    NANOINFER_REGISTER_LOADER_IMPL(__LINE__, name, creator)
