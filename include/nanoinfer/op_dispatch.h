...
#define NANOINFER_REGISTER_OP_KERNEL(op, dev, fn)                             \
    static ::nanoinfer::OpKernelAutoRegister _op_kernel_reg_##op##_##dev(     \
        ::nanoinfer::OpType::op, ::nanoinfer::DeviceType::dev, fn)
