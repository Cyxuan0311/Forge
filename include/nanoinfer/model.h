...
#define NANOINFER_REGISTER_CONFIG_PARSER_IMPL2(line, arch, fn) \
    static ::nanoinfer::ConfigParserAutoRegister _config_parser_reg_##line(arch, fn)

#define NANOINFER_REGISTER_CONFIG_PARSER_IMPL(line, arch, fn) \
    NANOINFER_REGISTER_CONFIG_PARSER_IMPL2(line, arch, fn)

#define NANOINFER_REGISTER_CONFIG_PARSER(arch, fn) \
    NANOINFER_REGISTER_CONFIG_PARSER_IMPL(__LINE__, arch, fn)
...
#define NANOINFER_REGISTER_WEIGHT_INIT_IMPL2(line, arch, fn) \
    static ::nanoinfer::WeightInitAutoRegister _weight_init_reg_##line(arch, fn)

#define NANOINFER_REGISTER_WEIGHT_INIT_IMPL(line, arch, fn) \
    NANOINFER_REGISTER_WEIGHT_INIT_IMPL2(line, arch, fn)

#define NANOINFER_REGISTER_WEIGHT_INIT(arch, fn) \
    NANOINFER_REGISTER_WEIGHT_INIT_IMPL(__LINE__, arch, fn)
...
#define NANOINFER_REGISTER_ARCH_CAPABILITY_IMPL2(line, arch, cap) \
    static ::nanoinfer::ArchCapabilityAutoRegister _arch_cap_reg_##line(arch, cap)

#define NANOINFER_REGISTER_ARCH_CAPABILITY_IMPL(line, arch, cap) \
    NANOINFER_REGISTER_ARCH_CAPABILITY_IMPL2(line, arch, cap)

#define NANOINFER_REGISTER_ARCH_CAPABILITY(arch, cap) \
    NANOINFER_REGISTER_ARCH_CAPABILITY_IMPL(__LINE__, arch, cap)
...
#define NANOINFER_REGISTER_ARCH_IMPL2(line, arch, engine_creator, config_fn, weight_init_fn, cap) \
    static ::nanoinfer::EngineAutoRegister _engine_reg_##line(arch, engine_creator); \
    static ::nanoinfer::ConfigParserAutoRegister _config_parser_reg_##line(arch, config_fn); \
    static ::nanoinfer::WeightInitAutoRegister _weight_init_reg_##line(arch, weight_init_fn); \
    static ::nanoinfer::ArchCapabilityAutoRegister _arch_cap_reg_##line(arch, cap)

#define NANOINFER_REGISTER_ARCH_IMPL(line, arch, engine_creator, config_fn, weight_init_fn, cap) \
    NANOINFER_REGISTER_ARCH_IMPL2(line, arch, engine_creator, config_fn, weight_init_fn, cap)

#define NANOINFER_REGISTER_ARCH(arch, engine_creator, config_fn, weight_init_fn, cap) \
    NANOINFER_REGISTER_ARCH_IMPL(__LINE__, arch, engine_creator, config_fn, weight_init_fn, cap)
